-- Final Working Setup SQL for Server Controlled Extension
-- This will work with your existing table structure

-- Step 1: Insert/Update Demo Features
...
-- Step 2: Insert/Update Extension Config
...
-- Step 3: Insert/Update System Settings
...
-- If no users exist, create them in Supabase Auth Dashboard:
-- 1. Go to Authentication > Users
-- 2. Add user: admin@example.com / admin123
-- 3. Add user: user@example.com / user123
-- 4. Copy their UUIDs

-- Step 5: After creating users in auth.users, insert them into users table
